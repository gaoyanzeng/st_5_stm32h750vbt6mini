...
//  MX_USB_DEVICE_Init();
  ...
  {	
	...
	//		也就是说用户不读日期的话，时间值会被锁定	
		...
		printf("%d-%d-%d ",Date_Struct.Year+2023,Date_Struct.Month,Date_Struct.Date);
		printf("%d:%d:%d\r\n",Time_Struct.Hours+23,Time_Struct.Minutes,Time_Struct.Seconds);
		HAL_Delay(1000);
